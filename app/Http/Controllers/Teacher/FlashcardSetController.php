...
class FlashcardSetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $flashcardSets = $request->user()->flashcardSets()->latest()->paginate(10);

        return view('teacher.flashcard-sets.index', compact('flashcardSets'));
    }
    ...
    public function create()
    {
        ...
        return view('teacher.flashcard-sets.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('teacher.flashcard-sets.index')
    ...
    public function show(FlashcardSet $flashcardSet)
    {
        ...
        return view('teacher.flashcard-sets.show', compact('flashcardSet'));
    }
    ...
    public function edit(FlashcardSet $flashcardSet)
    {
        ...
        return view('teacher.flashcard-sets.edit', compact('flashcardSet'));
    }
