...
class FlashcardController extends Controller
{
    ...
    {
        $this->authorize('viewAny', [Flashcard::class, $flashcardSet]);
    ...
    public function store(Request $request, FlashcardSet $flashcardSet)
    {
        ...
        return redirect()->route('admin.flashcard-sets.show', $flashcardSet)
    ...
    public function show(FlashcardSet $flashcardSet, Flashcard $flashcard)
    {
        ...
        return view('admin.flashcards.show', compact('flashcardSet', 'flashcard'));
    }
    ...
    public function edit(FlashcardSet $flashcardSet, Flashcard $flashcard)
    {
        ...
        return view('admin.flashcards.edit', compact('flashcardSet', 'flashcard'));
    }
    ...
    {
        $this->authorize('create', [Flashcard::class, $flashcardSet]);
